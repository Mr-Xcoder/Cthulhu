...
- Cthulhu will heavily rely on the *arities* (see below) of its functions, and there won't be any functions of unbounded arity (except for printing with `§`, see below), because that wouldn't be beneficial for golfing. 
